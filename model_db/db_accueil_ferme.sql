...
CREATE TABLE IF NOT EXISTS `groupe` (
  ...
  `comment` TEXT NULL,
  `phone` VARCHAR(20) NULL,
  `is_family` TINYINT(1) NULL,
  `event_pk` INT NULL,
  `was_canceled` TINYINT(1) NULL,
  PRIMARY KEY (`pk`),
  INDEX `fk_famille_adresse1_idx` (`address_pk` ASC),
...
CREATE TABLE IF NOT EXISTS `person_has_group` (
  ...
  `group_link_pk` INT NULL,
  `was_removed` TINYINT(1) NULL,
  `update_date` DATETIME NULL,
  `event_pk` INT NULL,
  PRIMARY KEY (`person_id`, `group_id`),
  INDEX `fk_personnes_has_famille_famille1_idx` (`group_id` ASC),
  ...
  INDEX `fk_person_has_group_event1_idx` (`event_pk` ASC),
  ...
  CONSTRAINT `fk_personne_has_famille_lien_famille1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_person_has_group_event1`
    FOREIGN KEY (`event_pk`)
    REFERENCES `event` (`pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `registration` (
  ...
  `payment_pk` INT NULL,
  `comment` TEXT NULL,
  `registration_type_pk` INT NULL,
  `will_come` TINYINT(1) NULL,
  PRIMARY KEY (`pk`),
...
CREATE TABLE IF NOT EXISTS `registration_options` (
  ...
  `parent_pk` INT NULL,
  PRIMARY KEY (`pk`),
  INDEX `fk_registration_options_event1_idx` (`event_pk` ASC),
  INDEX `fk_registration_options_registration_options1_idx` (`parent_pk` ASC),
  UNIQUE INDEX `uniq_register_option` (`slug` ASC, `event_pk` ASC, `parent_pk` ASC),
  CONSTRAINT `fk_registration_options_event1`
    FOREIGN KEY (`event_pk`)
    REFERENCES `event` (`pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_registration_options_registration_options1`
    FOREIGN KEY (`parent_pk`)
    REFERENCES `registration_options` (`pk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
